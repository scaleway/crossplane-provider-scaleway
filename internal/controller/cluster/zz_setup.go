...
import (
	...
	alert "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/billing/alert"
	budget "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/billing/budget"
	notification "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/billing/notification"
	...
	exporter "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/cockpit/exporter"
	...
	datalab "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/datalab/datalab"
	...
	certificate "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/iam/certificate"
	...
	saml "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/iam/saml"
	scim "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/iam/scim"
	sshkeyiam "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/iam/sshkey"
	tokeniam "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/iam/token"
	...
	link "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/interlink/link"
	policyinterlink "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/interlink/policy"
	...
	clusterkafka "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/kafka/cluster"
	key "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/keymanager/key"
	material "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/keymanager/material"
	backend "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/lb/backend"
	certificatelb "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/lb/certificate"
	...
	configuration "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/object/configuration"
	...
	deploymentopensearch "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/opensearch/deployment"
	...
	connector "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/vpc/connector"
	...
	rule "github.com/scaleway/crossplane-provider-scaleway/internal/controller/cluster/vpc/rule"
...
func SetupWebhookWithManager(mgr ctrl.Manager) error {
	for _, setup := range []func(ctrl.Manager) error{
		...
		serverbaremetal.SetupWebhookWithManager,
		...
		containernamespace.SetupWebhookWithManager,
		cron.SetupWebhookWithManager,
		domain.SetupWebhookWithManager,
		tokencontainer.SetupWebhookWithManager,
		datalab.SetupWebhookWithManager,
		...
		backendstage.SetupWebhookWithManager,
		cachestage.SetupWebhookWithManager,
		dnsstage.SetupWebhookWithManager,
		headstage.SetupWebhookWithManager,
		pipeline.SetupWebhookWithManager,
		plan.SetupWebhookWithManager,
		routestage.SetupWebhookWithManager,
		tlsstage.SetupWebhookWithManager,
		wafstage.SetupWebhookWithManager,
		filesystem.SetupWebhookWithManager,
		ip.SetupWebhookWithManager,
		cronfunction.SetupWebhookWithManager,
		domainfunction.SetupWebhookWithManager,
		function.SetupWebhookWithManager,
		functionnamespace.SetupWebhookWithManager,
		tokenfunction.SetupWebhookWithManager,
		...
		sshkeyiam.SetupWebhookWithManager,
		tokeniam.SetupWebhookWithManager,
		useriam.SetupWebhookWithManager,
		deploymentinference.SetupWebhookWithManager,
		model.SetupWebhookWithManager,
		image.SetupWebhookWithManager,
		ipinstance.SetupWebhookWithManager,
		placementgroup.SetupWebhookWithManager,
		privatenic.SetupWebhookWithManager,
		securitygroup.SetupWebhookWithManager,
		securitygrouprule.SetupWebhookWithManager,
		serverinstance.SetupWebhookWithManager,
		snapshotinstance.SetupWebhookWithManager,
		userdata.SetupWebhookWithManager,
		volumeinstance.SetupWebhookWithManager,
		link.SetupWebhookWithManager,
		policyinterlink.SetupWebhookWithManager,
		device.SetupWebhookWithManager,
		hub.SetupWebhookWithManager,
		network.SetupWebhookWithManager,
		route.SetupWebhookWithManager,
		ipipam.SetupWebhookWithManager,
		ipreversedns.SetupWebhookWithManager,
		...
		material.SetupWebhookWithManager,
		backend.SetupWebhookWithManager,
		certificatelb.SetupWebhookWithManager,
		frontend.SetupWebhookWithManager,
		iplb.SetupWebhookWithManager,
		lb.SetupWebhookWithManager,
		privatenetwork.SetupWebhookWithManager,
		routelb.SetupWebhookWithManager,
		natsaccount.SetupWebhookWithManager,
		natscredentials.SetupWebhookWithManager,
		sns.SetupWebhookWithManager,
		snscredentials.SetupWebhookWithManager,
		snstopic.SetupWebhookWithManager,
		snstopicsubscription.SetupWebhookWithManager,
		sqs.SetupWebhookWithManager,
		sqscredentials.SetupWebhookWithManager,
		sqsqueue.SetupWebhookWithManager,
		instance.SetupWebhookWithManager,
		snapshotmongodb.SetupWebhookWithManager,
		usermongodb.SetupWebhookWithManager,
		aclobject.SetupWebhookWithManager,
		bucket.SetupWebhookWithManager,
		configuration.SetupWebhookWithManager,
		lockconfiguration.SetupWebhookWithManager,
		object.SetupWebhookWithManager,
		policyobject.SetupWebhookWithManager,
		websiteconfiguration.SetupWebhookWithManager,
		deploymentopensearch.SetupWebhookWithManager,
		providerconfig.SetupWebhookWithManager,
		aclrdb.SetupWebhookWithManager,
		databaserdb.SetupWebhookWithManager,
		databasebackup.SetupWebhookWithManager,
		instancerdb.SetupWebhookWithManager,
		privilege.SetupWebhookWithManager,
		readreplica.SetupWebhookWithManager,
		snapshotrdb.SetupWebhookWithManager,
		userrdb.SetupWebhookWithManager,
		...
		policys2svpn.SetupWebhookWithManager,
		sqldatabase.SetupWebhookWithManager,
		secret.SetupWebhookWithManager,
		version.SetupWebhookWithManager,
		domaintem.SetupWebhookWithManager,
		list.SetupWebhookWithManager,
		webhook.SetupWebhookWithManager,
		aclvpc.SetupWebhookWithManager,
		connector.SetupWebhookWithManager,
		gatewaynetwork.SetupWebhookWithManager,
		privatenetworkvpc.SetupWebhookWithManager,
		publicgateway.SetupWebhookWithManager,
		publicgatewaydhcp.SetupWebhookWithManager,
		publicgatewayip.SetupWebhookWithManager,
		publicgatewaypatrule.SetupWebhookWithManager,
		routevpc.SetupWebhookWithManager,
