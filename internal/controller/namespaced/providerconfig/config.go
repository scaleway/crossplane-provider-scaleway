...
import (
	...
	"github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/v1beta1"
)
...
// by accounting for their current usage, with gated setup for SafeStart capability
