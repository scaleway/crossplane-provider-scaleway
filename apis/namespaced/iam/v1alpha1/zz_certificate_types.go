...
type CertificateInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/iam/v1alpha1.Saml
	SAMLID *string `json:"samlId,omitempty" tf:"saml_id,omitempty"`

	// Reference to a Saml in iam to populate samlId.
	// +kubebuilder:validation:Optional
	SAMLIDRef *v1.NamespacedReference `json:"samlIdRef,omitempty" tf:"-"`

	// Selector for a Saml in iam to populate samlId.
	// +kubebuilder:validation:Optional
	SAMLIDSelector *v1.NamespacedSelector `json:"samlIdSelector,omitempty" tf:"-"`
