...
type GroupInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/iam/v1alpha1.Application
	// +listType=set
	...
	ApplicationIdsRefs []v1.NamespacedReference `json:"applicationIdsRefs,omitempty" tf:"-"`

	// Selector for a list of Application in iam to populate applicationIds.
	// +kubebuilder:validation:Optional
	ApplicationIdsSelector *v1.NamespacedSelector `json:"applicationIdsSelector,omitempty" tf:"-"`
