...
type TokenInitParameters struct {
	...
	// Container ID
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/container/v1alpha1.Container
	...
	// Namespace ID
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/container/v1alpha1.ContainerNamespace
