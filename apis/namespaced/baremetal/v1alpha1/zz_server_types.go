...
type ServerInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/account/v1alpha1.SSHKey
	SSHKeyIds []*string `json:"sshKeyIds,omitempty" tf:"ssh_key_ids,omitempty"`

	// References to SSHKey in account to populate sshKeyIds.
	// +kubebuilder:validation:Optional
	SSHKeyIdsRefs []v1.NamespacedReference `json:"sshKeyIdsRefs,omitempty" tf:"-"`

	// Selector for a list of SSHKey in account to populate sshKeyIds.
	// +kubebuilder:validation:Optional
	SSHKeyIdsSelector *v1.NamespacedSelector `json:"sshKeyIdsSelector,omitempty" tf:"-"`
