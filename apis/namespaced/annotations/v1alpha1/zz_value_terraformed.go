...
func (mg *Value) GetTerraformResourceType() string {
	return "scaleway_annotations_value"
}
...
func (tr *Value) GetObservation() (map[string]any, error) {
...
func (tr *Value) SetObservation(obs map[string]any) error {
...
func (tr *Value) GetParameters() (map[string]any, error) {
...
func (tr *Value) SetParameters(params map[string]any) error {
...
// GetInitParameters of this Value
func (tr *Value) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Value
func (tr *Value) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
