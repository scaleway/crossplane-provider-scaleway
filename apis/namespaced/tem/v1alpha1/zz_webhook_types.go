...
type WebhookInitParameters struct {
	...
	// SNS ARN
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/mnq/v1alpha1.SNSTopic
	SnsArn *string `json:"snsArn,omitempty" tf:"sns_arn,omitempty"`

	// Reference to a SNSTopic in mnq to populate snsArn.
	// +kubebuilder:validation:Optional
	SnsArnRef *v1.NamespacedReference `json:"snsArnRef,omitempty" tf:"-"`

	// Selector for a SNSTopic in mnq to populate snsArn.
	// +kubebuilder:validation:Optional
	SnsArnSelector *v1.NamespacedSelector `json:"snsArnSelector,omitempty" tf:"-"`
}
