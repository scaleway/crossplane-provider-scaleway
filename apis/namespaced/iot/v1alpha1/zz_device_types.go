...
type CertificateInitParameters struct {
	...
	CrtSecretRef *v1.LocalSecretKeySelector `json:"crtSecretRef,omitempty" tf:"-"`
}
...
type DeviceInitParameters struct {
	...
	// The ID of the hub on which this device will be created
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/iot/v1alpha1.Hub
	HubID *string `json:"hubId,omitempty" tf:"hub_id,omitempty"`

	// Reference to a Hub in iot to populate hubId.
	// +kubebuilder:validation:Optional
	HubIDRef *v1.NamespacedReference `json:"hubIdRef,omitempty" tf:"-"`

	// Selector for a Hub in iot to populate hubId.
	// +kubebuilder:validation:Optional
	HubIDSelector *v1.NamespacedSelector `json:"hubIdSelector,omitempty" tf:"-"`
