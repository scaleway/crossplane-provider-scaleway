...
type RouteStageInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	WafStageIDRef *v1.NamespacedReference `json:"wafStageIdRef,omitempty" tf:"-"`

	// Selector for a WAFStage in edgeservices to populate wafStageId.
	// +kubebuilder:validation:Optional
	WafStageIDSelector *v1.NamespacedSelector `json:"wafStageIdSelector,omitempty" tf:"-"`
}
...
type RuleInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	BackendStageIDRef *v1.NamespacedReference `json:"backendStageIdRef,omitempty" tf:"-"`
