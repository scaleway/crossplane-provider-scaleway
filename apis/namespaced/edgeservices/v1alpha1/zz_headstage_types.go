...
type HeadStageInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/edgeservices/v1alpha1.DNSStage
	...
	HeadStageIDRef *v1.NamespacedReference `json:"headStageIdRef,omitempty" tf:"-"`

	// Selector for a DNSStage in edgeservices to populate headStageId.
	// +kubebuilder:validation:Optional
	HeadStageIDSelector *v1.NamespacedSelector `json:"headStageIdSelector,omitempty" tf:"-"`
