...
func (in *ConnectorInitParameters) DeepCopyInto(out *ConnectorInitParameters) {
	*out = *in
	...
	if in.TargetVPCID != nil {
		in, out := &in.TargetVPCID, &out.TargetVPCID
		*out = new(string)
		**out = **in
	}
	if in.TargetVPCIDRef != nil {
		in, out := &in.TargetVPCIDRef, &out.TargetVPCIDRef
		*out = new(v1.NamespacedReference)
		(*in).DeepCopyInto(*out)
	}
	if in.TargetVPCIDSelector != nil {
		in, out := &in.TargetVPCIDSelector, &out.TargetVPCIDSelector
		*out = new(v1.NamespacedSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.VPCID != nil {
...
func (in *RuleInitParameters) DeepCopyInto(out *RuleInitParameters) {
	*out = *in
	...
	if in.NexthopPrivateNetworkIDRef != nil {
		in, out := &in.NexthopPrivateNetworkIDRef, &out.NexthopPrivateNetworkIDRef
		*out = new(v1.NamespacedReference)
		(*in).DeepCopyInto(*out)
	}
	if in.NexthopPrivateNetworkIDSelector != nil {
		in, out := &in.NexthopPrivateNetworkIDSelector, &out.NexthopPrivateNetworkIDSelector
		*out = new(v1.NamespacedSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.NexthopResourceIP != nil {
		in, out := &in.NexthopResourceIP, &out.NexthopResourceIP
		*out = new(string)
		**out = **in
	}
	if in.Region != nil {
