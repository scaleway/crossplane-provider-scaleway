...
type RouteInitParameters struct {
	...
	BackendIDRef *v1.NamespacedReference `json:"backendIdRef,omitempty" tf:"-"`

	// Selector for a Backend in lb to populate backendId.
	// +kubebuilder:validation:Optional
	BackendIDSelector *v1.NamespacedSelector `json:"backendIdSelector,omitempty" tf:"-"`

	// The ID of the frontend the route is associated with.
	// The frontend ID origin of redirection
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/lb/v1alpha1.Frontend
	FrontendID *string `json:"frontendId,omitempty" tf:"frontend_id,omitempty"`

	// Reference to a Frontend in lb to populate frontendId.
	// +kubebuilder:validation:Optional
	FrontendIDRef *v1.NamespacedReference `json:"frontendIdRef,omitempty" tf:"-"`

	// Selector for a Frontend in lb to populate frontendId.
	// +kubebuilder:validation:Optional
	FrontendIDSelector *v1.NamespacedSelector `json:"frontendIdSelector,omitempty" tf:"-"`
