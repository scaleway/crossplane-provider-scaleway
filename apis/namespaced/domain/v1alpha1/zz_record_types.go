...
type RecordInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/domain/v1alpha1.Zone
	DNSZone *string `json:"dnsZone,omitempty" tf:"dns_zone,omitempty"`

	// Reference to a Zone in domain to populate dnsZone.
	// +kubebuilder:validation:Optional
	DNSZoneRef *v1.NamespacedReference `json:"dnsZoneRef,omitempty" tf:"-"`

	// Selector for a Zone in domain to populate dnsZone.
	// +kubebuilder:validation:Optional
	DNSZoneSelector *v1.NamespacedSelector `json:"dnsZoneSelector,omitempty" tf:"-"`
