...
type GroupInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/autoscaling/v1alpha1.Template
...
type LoadBalancerInitParameters struct {
	...
	// The Load Balancer backend IDs
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/lb/v1alpha1.Backend
	BackendIds []*string `json:"backendIds,omitempty" tf:"backend_ids,omitempty"`

	// References to Backend in lb to populate backendIds.
	// +kubebuilder:validation:Optional
	BackendIdsRefs []v1.NamespacedReference `json:"backendIdsRefs,omitempty" tf:"-"`

	// Selector for a list of Backend in lb to populate backendIds.
	// +kubebuilder:validation:Optional
	BackendIdsSelector *v1.NamespacedSelector `json:"backendIdsSelector,omitempty" tf:"-"`

	// The ID of the Load Balancer.
	// The ID of the load balancer
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/lb/v1alpha1.LB
	ID *string `json:"id,omitempty" tf:"id,omitempty"`
