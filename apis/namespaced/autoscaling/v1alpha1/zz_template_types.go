...
type FromSnapshotInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/block/v1alpha1.Snapshot
...
type TemplateInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	PrivateNetworkIdsRefs []v1.NamespacedReference `json:"privateNetworkIdsRefs,omitempty" tf:"-"`

	// Selector for a list of PrivateNetwork in vpc to populate privateNetworkIds.
	// +kubebuilder:validation:Optional
	PrivateNetworkIdsSelector *v1.NamespacedSelector `json:"privateNetworkIdsSelector,omitempty" tf:"-"`
