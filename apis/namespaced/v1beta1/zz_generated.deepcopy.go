...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScwConfig) DeepCopyInto(out *ScwConfig) {
	*out = *in
	if in.UseScwConfig != nil {
		in, out := &in.UseScwConfig, &out.UseScwConfig
		*out = new(bool)
		**out = **in
	}
	if in.Path != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScwConfig.
func (in *ScwConfig) DeepCopy() *ScwConfig {
	if in == nil {
		return nil
	}
	out := new(ScwConfig)
