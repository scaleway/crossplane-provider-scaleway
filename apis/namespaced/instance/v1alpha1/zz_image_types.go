...
type ImageInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/instance/v1alpha1.Snapshot
	...
	RootVolumeIDRef *v1.NamespacedReference `json:"rootVolumeIdRef,omitempty" tf:"-"`

	// Selector for a Snapshot in instance to populate rootVolumeId.
	// +kubebuilder:validation:Optional
	RootVolumeIDSelector *v1.NamespacedSelector `json:"rootVolumeIdSelector,omitempty" tf:"-"`
