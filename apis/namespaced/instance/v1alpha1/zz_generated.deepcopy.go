...
func (in *PrivateNICInitParameters) DeepCopy() *PrivateNICInitParameters {
	if in == nil {
		return nil
	}
	out := new(PrivateNICInitParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PrivateNICObservation) DeepCopy() *PrivateNICObservation {
	if in == nil {
		return nil
	}
	out := new(PrivateNICObservation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PrivateNICParameters) DeepCopy() *PrivateNICParameters {
	if in == nil {
		return nil
	}
	out := new(PrivateNICParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServerInitParameters) DeepCopyInto(out *ServerInitParameters) {
	*out = *in
	...
	if in.AdminPasswordEncryptionSSHKeyID != nil {
		in, out := &in.AdminPasswordEncryptionSSHKeyID, &out.AdminPasswordEncryptionSSHKeyID
		*out = new(string)
		**out = **in
	}
	if in.BootType != nil {
	...
	if in.PrivateIps != nil {
		in, out := &in.PrivateIps, &out.PrivateIps
		*out = make([]ServerPrivateIpsInitParameters, len(*in))
		copy(*out, *in)
	}
	...
	if in.RootVolume != nil {
		in, out := &in.RootVolume, &out.RootVolume
		*out = make([]ServerRootVolumeInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ServerObservation) DeepCopyInto(out *ServerObservation) {
	*out = *in
	...
	if in.PrivateIps != nil {
		in, out := &in.PrivateIps, &out.PrivateIps
		*out = make([]ServerPrivateIpsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.RootVolume != nil {
		in, out := &in.RootVolume, &out.RootVolume
		*out = make([]ServerRootVolumeObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ServerParameters) DeepCopyInto(out *ServerParameters) {
	*out = *in
	...
	if in.PrivateIps != nil {
		in, out := &in.PrivateIps, &out.PrivateIps
		*out = make([]ServerPrivateIpsParameters, len(*in))
		copy(*out, *in)
	}
	if in.PrivateNetwork != nil {
		in, out := &in.PrivateNetwork, &out.PrivateNetwork
	...
	if in.RootVolume != nil {
		in, out := &in.RootVolume, &out.RootVolume
		*out = make([]ServerRootVolumeParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServerPrivateIpsInitParameters) DeepCopyInto(out *ServerPrivateIpsInitParameters) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServerPrivateIpsInitParameters.
func (in *ServerPrivateIpsInitParameters) DeepCopy() *ServerPrivateIpsInitParameters {
	if in == nil {
		return nil
	}
	out := new(ServerPrivateIpsInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServerPrivateIpsObservation) DeepCopyInto(out *ServerPrivateIpsObservation) {
	*out = *in
	if in.Address != nil {
		in, out := &in.Address, &out.Address
		*out = new(string)
...
func (in *ServerPrivateIpsObservation) DeepCopy() *ServerPrivateIpsObservation {
	if in == nil {
		return nil
	}
	out := new(ServerPrivateIpsObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServerPrivateIpsParameters) DeepCopyInto(out *ServerPrivateIpsParameters) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServerPrivateIpsParameters.
func (in *ServerPrivateIpsParameters) DeepCopy() *ServerPrivateIpsParameters {
	if in == nil {
		return nil
	}
	out := new(ServerPrivateIpsParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServerRootVolumeInitParameters) DeepCopyInto(out *ServerRootVolumeInitParameters) {
	*out = *in
	if in.Boot != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServerRootVolumeInitParameters.
func (in *ServerRootVolumeInitParameters) DeepCopy() *ServerRootVolumeInitParameters {
	if in == nil {
		return nil
	}
	out := new(ServerRootVolumeInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServerRootVolumeObservation) DeepCopyInto(out *ServerRootVolumeObservation) {
	*out = *in
	if in.Boot != nil {
		in, out := &in.Boot, &out.Boot
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServerRootVolumeObservation.
func (in *ServerRootVolumeObservation) DeepCopy() *ServerRootVolumeObservation {
	if in == nil {
		return nil
	}
	out := new(ServerRootVolumeObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServerRootVolumeParameters) DeepCopyInto(out *ServerRootVolumeParameters) {
	*out = *in
	if in.Boot != nil {
		in, out := &in.Boot, &out.Boot
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServerRootVolumeParameters.
func (in *ServerRootVolumeParameters) DeepCopy() *ServerRootVolumeParameters {
	if in == nil {
		return nil
	}
	out := new(ServerRootVolumeParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TemplateInitParameters) DeepCopyInto(out *TemplateInitParameters) {
	*out = *in
	if in.FilesystemIds != nil {
		in, out := &in.FilesystemIds, &out.FilesystemIds
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.FilesystemIdsRefs != nil {
		in, out := &in.FilesystemIdsRefs, &out.FilesystemIdsRefs
		*out = make([]v1.NamespacedReference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.FilesystemIdsSelector != nil {
		in, out := &in.FilesystemIdsSelector, &out.FilesystemIdsSelector
		*out = new(v1.NamespacedSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.Name != nil {
	...
	if in.PublicIPv4Count != nil {
		in, out := &in.PublicIPv4Count, &out.PublicIPv4Count
		*out = new(float64)
		**out = **in
	}
	if in.PublicIPv6Count != nil {
		in, out := &in.PublicIPv6Count, &out.PublicIPv6Count
		*out = new(float64)
		**out = **in
	}
	if in.SecurityGroupID != nil {
	...
	if in.WindowsRdpSSHKeyID != nil {
		in, out := &in.WindowsRdpSSHKeyID, &out.WindowsRdpSSHKeyID
		*out = new(string)
		**out = **in
	}
	if in.WindowsRdpSSHKeyIDRef != nil {
		in, out := &in.WindowsRdpSSHKeyIDRef, &out.WindowsRdpSSHKeyIDRef
		*out = new(v1.NamespacedReference)
		(*in).DeepCopyInto(*out)
	}
	if in.WindowsRdpSSHKeyIDSelector != nil {
		in, out := &in.WindowsRdpSSHKeyIDSelector, &out.WindowsRdpSSHKeyIDSelector
		*out = new(v1.NamespacedSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.Zone != nil {
...
func (in *VolumeInitParameters) DeepCopyInto(out *VolumeInitParameters) {
	*out = *in
	...
	if in.MigrateToSbs != nil {
		in, out := &in.MigrateToSbs, &out.MigrateToSbs
		*out = new(bool)
		**out = **in
	}
	if in.Name != nil {
...
func (in *VolumesInitParameters) DeepCopyInto(out *VolumesInitParameters) {
	*out = *in
	if in.BaseSnapshotID != nil {
		in, out := &in.BaseSnapshotID, &out.BaseSnapshotID
		*out = new(string)
		**out = **in
	}
	if in.ImageLabel != nil {
		in, out := &in.ImageLabel, &out.ImageLabel
		*out = new(string)
		**out = **in
	}
	if in.Name != nil {
