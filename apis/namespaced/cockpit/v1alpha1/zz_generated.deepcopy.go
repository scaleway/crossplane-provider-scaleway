...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DatadogDestinationInitParameters) DeepCopyInto(out *DatadogDestinationInitParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DatadogDestinationInitParameters.
func (in *DatadogDestinationInitParameters) DeepCopy() *DatadogDestinationInitParameters {
	if in == nil {
		return nil
	}
	out := new(DatadogDestinationInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DatadogDestinationObservation) DeepCopyInto(out *DatadogDestinationObservation) {
	*out = *in
	if in.Endpoint != nil {
		in, out := &in.Endpoint, &out.Endpoint
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DatadogDestinationObservation.
func (in *DatadogDestinationObservation) DeepCopy() *DatadogDestinationObservation {
	if in == nil {
		return nil
	}
	out := new(DatadogDestinationObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DatadogDestinationParameters) DeepCopyInto(out *DatadogDestinationParameters) {
	*out = *in
	in.APIKeySecretRef.DeepCopyInto(&out.APIKeySecretRef)
	if in.Endpoint != nil {
		in, out := &in.Endpoint, &out.Endpoint
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DatadogDestinationParameters.
func (in *DatadogDestinationParameters) DeepCopy() *DatadogDestinationParameters {
	if in == nil {
		return nil
	}
	out := new(DatadogDestinationParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ExporterInitParameters) DeepCopyInto(out *ExporterInitParameters) {
	*out = *in
	if in.DatadogDestination != nil {
		in, out := &in.DatadogDestination, &out.DatadogDestination
		*out = make([]DatadogDestinationInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.ExportedProducts != nil {
		in, out := &in.ExportedProducts, &out.ExportedProducts
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.OtlpDestination != nil {
		in, out := &in.OtlpDestination, &out.OtlpDestination
		*out = make([]OtlpDestinationInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ExporterObservation) DeepCopyInto(out *ExporterObservation) {
	*out = *in
	...
	if in.DatadogDestination != nil {
		in, out := &in.DatadogDestination, &out.DatadogDestination
		*out = make([]DatadogDestinationObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.OtlpDestination != nil {
		in, out := &in.OtlpDestination, &out.OtlpDestination
		*out = make([]OtlpDestinationObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ExporterParameters) DeepCopyInto(out *ExporterParameters) {
	*out = *in
	if in.DatadogDestination != nil {
		in, out := &in.DatadogDestination, &out.DatadogDestination
		*out = make([]DatadogDestinationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.OtlpDestination != nil {
		in, out := &in.OtlpDestination, &out.OtlpDestination
		*out = make([]OtlpDestinationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OtlpDestinationInitParameters) DeepCopyInto(out *OtlpDestinationInitParameters) {
	*out = *in
	if in.Endpoint != nil {
		in, out := &in.Endpoint, &out.Endpoint
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OtlpDestinationInitParameters.
func (in *OtlpDestinationInitParameters) DeepCopy() *OtlpDestinationInitParameters {
	if in == nil {
		return nil
	}
	out := new(OtlpDestinationInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OtlpDestinationObservation) DeepCopyInto(out *OtlpDestinationObservation) {
	*out = *in
	if in.Endpoint != nil {
		in, out := &in.Endpoint, &out.Endpoint
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OtlpDestinationObservation.
func (in *OtlpDestinationObservation) DeepCopy() *OtlpDestinationObservation {
	if in == nil {
		return nil
	}
	out := new(OtlpDestinationObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OtlpDestinationParameters) DeepCopyInto(out *OtlpDestinationParameters) {
	*out = *in
	if in.Endpoint != nil {
		in, out := &in.Endpoint, &out.Endpoint
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OtlpDestinationParameters.
func (in *OtlpDestinationParameters) DeepCopy() *OtlpDestinationParameters {
	if in == nil {
		return nil
	}
	out := new(OtlpDestinationParameters)
	in.DeepCopyInto(out)
	return out
}
