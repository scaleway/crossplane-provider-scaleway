...
type SQSQueueInitParameters struct {
	...
	// The sqs endpoint
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/mnq/v1alpha1.SQS
	...
	// +kubebuilder:validation:Optional
	SqsEndpointRef *v1.NamespacedReference `json:"sqsEndpointRef,omitempty" tf:"-"`

	// Selector for a SQS in mnq to populate sqsEndpoint.
	// +kubebuilder:validation:Optional
	SqsEndpointSelector *v1.NamespacedSelector `json:"sqsEndpointSelector,omitempty" tf:"-"`
