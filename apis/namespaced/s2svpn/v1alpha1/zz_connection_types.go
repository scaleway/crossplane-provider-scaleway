...
type BGPConfigIPv4InitParameters struct {
	...
	// The ID of the routing policy to use for BGP route filtering
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/s2svpn/v1alpha1.Policy
	...
	RoutingPolicyIDRef *v1.NamespacedReference `json:"routingPolicyIdRef,omitempty" tf:"-"`

	// Selector for a Policy in s2svpn to populate routingPolicyId.
	// +kubebuilder:validation:Optional
	RoutingPolicyIDSelector *v1.NamespacedSelector `json:"routingPolicyIdSelector,omitempty" tf:"-"`
}
...
type ConnectionInitParameters struct {
	...
	// The ID of the customer gateway to attach to the connection
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/s2svpn/v1alpha1.CustomerGateway
	...
	// The ID of the VPN gateway to attach to the connection
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/namespaced/s2svpn/v1alpha1.Gateway
