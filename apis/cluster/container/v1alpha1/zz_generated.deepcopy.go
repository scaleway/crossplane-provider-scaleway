...
func (in *ContainerInitParameters) DeepCopyInto(out *ContainerInitParameters) {
	*out = *in
	...
	if in.HTTPSConnectionsOnly != nil {
		in, out := &in.HTTPSConnectionsOnly, &out.HTTPSConnectionsOnly
		*out = new(bool)
		**out = **in
	}
	...
	if in.LocalStorageLimit != nil {
		in, out := &in.LocalStorageLimit, &out.LocalStorageLimit
		*out = new(float64)
		**out = **in
	}
	if in.LocalStorageLimitBytes != nil {
		in, out := &in.LocalStorageLimitBytes, &out.LocalStorageLimitBytes
		*out = new(float64)
		**out = **in
	}
	if in.MaxScale != nil {
	...
	if in.ScalingOption != nil {
		in, out := &in.ScalingOption, &out.ScalingOption
		*out = make([]ScalingOptionInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ContainerObservation) DeepCopyInto(out *ContainerObservation) {
	*out = *in
	...
	if in.ScalingOption != nil {
		in, out := &in.ScalingOption, &out.ScalingOption
		*out = make([]ScalingOptionObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ContainerParameters) DeepCopyInto(out *ContainerParameters) {
	*out = *in
	...
	if in.ScalingOption != nil {
		in, out := &in.ScalingOption, &out.ScalingOption
		*out = make([]ScalingOptionParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LivenessProbeHTTPInitParameters) DeepCopyInto(out *LivenessProbeHTTPInitParameters) {
	*out = *in
	if in.Path != nil {
		in, out := &in.Path, &out.Path
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LivenessProbeHTTPInitParameters.
func (in *LivenessProbeHTTPInitParameters) DeepCopy() *LivenessProbeHTTPInitParameters {
	if in == nil {
		return nil
	}
	out := new(LivenessProbeHTTPInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LivenessProbeHTTPObservation) DeepCopyInto(out *LivenessProbeHTTPObservation) {
	*out = *in
	if in.Path != nil {
		in, out := &in.Path, &out.Path
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LivenessProbeHTTPObservation.
func (in *LivenessProbeHTTPObservation) DeepCopy() *LivenessProbeHTTPObservation {
	if in == nil {
		return nil
	}
	out := new(LivenessProbeHTTPObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LivenessProbeHTTPParameters) DeepCopyInto(out *LivenessProbeHTTPParameters) {
	*out = *in
	if in.Path != nil {
		in, out := &in.Path, &out.Path
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LivenessProbeHTTPParameters.
func (in *LivenessProbeHTTPParameters) DeepCopy() *LivenessProbeHTTPParameters {
	if in == nil {
		return nil
	}
	out := new(LivenessProbeHTTPParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LivenessProbeInitParameters) DeepCopyInto(out *LivenessProbeInitParameters) {
	*out = *in
	...
	if in.HTTP != nil {
		in, out := &in.HTTP, &out.HTTP
		*out = make([]LivenessProbeHTTPInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *LivenessProbeObservation) DeepCopyInto(out *LivenessProbeObservation) {
	*out = *in
	...
	if in.HTTP != nil {
		in, out := &in.HTTP, &out.HTTP
		*out = make([]LivenessProbeHTTPObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *LivenessProbeParameters) DeepCopyInto(out *LivenessProbeParameters) {
	*out = *in
	...
	if in.HTTP != nil {
		in, out := &in.HTTP, &out.HTTP
		*out = make([]LivenessProbeHTTPParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScalingOptionInitParameters) DeepCopyInto(out *ScalingOptionInitParameters) {
	*out = *in
	if in.CPUUsageThreshold != nil {
		in, out := &in.CPUUsageThreshold, &out.CPUUsageThreshold
		*out = new(float64)
		**out = **in
	}
	if in.ConcurrentRequestsThreshold != nil {
		in, out := &in.ConcurrentRequestsThreshold, &out.ConcurrentRequestsThreshold
		*out = new(float64)
		**out = **in
	}
	if in.MemoryUsageThreshold != nil {
		in, out := &in.MemoryUsageThreshold, &out.MemoryUsageThreshold
		*out = new(float64)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScalingOptionInitParameters.
func (in *ScalingOptionInitParameters) DeepCopy() *ScalingOptionInitParameters {
	if in == nil {
		return nil
	}
	out := new(ScalingOptionInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScalingOptionObservation) DeepCopyInto(out *ScalingOptionObservation) {
	*out = *in
	if in.CPUUsageThreshold != nil {
		in, out := &in.CPUUsageThreshold, &out.CPUUsageThreshold
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScalingOptionObservation.
func (in *ScalingOptionObservation) DeepCopy() *ScalingOptionObservation {
	if in == nil {
		return nil
	}
	out := new(ScalingOptionObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScalingOptionParameters) DeepCopyInto(out *ScalingOptionParameters) {
	*out = *in
	if in.CPUUsageThreshold != nil {
		in, out := &in.CPUUsageThreshold, &out.CPUUsageThreshold
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScalingOptionParameters.
func (in *ScalingOptionParameters) DeepCopy() *ScalingOptionParameters {
	if in == nil {
		return nil
	}
	out := new(ScalingOptionParameters)
	in.DeepCopyInto(out)
	return out
}
