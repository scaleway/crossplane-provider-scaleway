...
type BindingInitParameters struct {
	...
	SrnRef *v1.Reference `json:"srnRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	ValueIDRef *v1.Reference `json:"valueIdRef,omitempty" tf:"-"`

	// Selector for a Value in annotations to populate valueId.
	// +kubebuilder:validation:Optional
	ValueIDSelector *v1.Selector `json:"valueIdSelector,omitempty" tf:"-"`
}
