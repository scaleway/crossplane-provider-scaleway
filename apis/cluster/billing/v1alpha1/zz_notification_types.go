...
type NotificationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/cluster/billing/v1alpha1.Alert
	...
	BudgetAlertIDRef *v1.Reference `json:"budgetAlertIdRef,omitempty" tf:"-"`

	// Selector for a Alert in billing to populate budgetAlertId.
	// +kubebuilder:validation:Optional
	BudgetAlertIDSelector *v1.Selector `json:"budgetAlertIdSelector,omitempty" tf:"-"`
