...
type PolicyInitParameters struct {
	...
	// Application id
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/cluster/iam/v1alpha1.Application
	...
	// Group id
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/cluster/iam/v1alpha1.Group
