...
func (mg *Connector) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.TargetVPCID),
		Extract:      reference.ExternalName(),
		Namespace:    mg.GetNamespace(),
		Reference:    mg.Spec.ForProvider.TargetVPCIDRef,
		Selector:     mg.Spec.ForProvider.TargetVPCIDSelector,
		To: reference.To{
			List:    &VPCList{},
			Managed: &VPC{},
		},
	...
	if err != nil {
		return errors.Wrap(err, "mg.Spec.ForProvider.TargetVPCID")
	}
	mg.Spec.ForProvider.TargetVPCID = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.ForProvider.TargetVPCIDRef = rsp.ResolvedReference
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.TargetVPCID),
		Extract:      reference.ExternalName(),
		Namespace:    mg.GetNamespace(),
		Reference:    mg.Spec.InitProvider.TargetVPCIDRef,
		Selector:     mg.Spec.InitProvider.TargetVPCIDSelector,
		To: reference.To{
			List:    &VPCList{},
			Managed: &VPC{},
		},
	...
	if err != nil {
		return errors.Wrap(err, "mg.Spec.InitProvider.TargetVPCID")
	}
	mg.Spec.InitProvider.TargetVPCID = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.InitProvider.TargetVPCIDRef = rsp.ResolvedReference
...
func (mg *Rule) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.NexthopPrivateNetworkID),
		Extract:      reference.ExternalName(),
		Namespace:    mg.GetNamespace(),
		Reference:    mg.Spec.ForProvider.NexthopPrivateNetworkIDRef,
		Selector:     mg.Spec.ForProvider.NexthopPrivateNetworkIDSelector,
		To: reference.To{
			List:    &PrivateNetworkList{},
			Managed: &PrivateNetwork{},
		},
	...
	if err != nil {
		return errors.Wrap(err, "mg.Spec.ForProvider.NexthopPrivateNetworkID")
	}
	mg.Spec.ForProvider.NexthopPrivateNetworkID = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.ForProvider.NexthopPrivateNetworkIDRef = rsp.ResolvedReference
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.NexthopPrivateNetworkID),
		Extract:      reference.ExternalName(),
		Namespace:    mg.GetNamespace(),
		Reference:    mg.Spec.InitProvider.NexthopPrivateNetworkIDRef,
		Selector:     mg.Spec.InitProvider.NexthopPrivateNetworkIDSelector,
		To: reference.To{
			List:    &PrivateNetworkList{},
			Managed: &PrivateNetwork{},
		},
	...
	if err != nil {
		return errors.Wrap(err, "mg.Spec.InitProvider.NexthopPrivateNetworkID")
	}
	mg.Spec.InitProvider.NexthopPrivateNetworkID = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.InitProvider.NexthopPrivateNetworkIDRef = rsp.ResolvedReference
