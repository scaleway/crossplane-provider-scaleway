...
type PolicyInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/cluster/autoscaling/v1alpha1.Group
	...
	// +kubebuilder:validation:Optional
	InstanceGroupIDRef *v1.Reference `json:"instanceGroupIdRef,omitempty" tf:"-"`

	// Selector for a Group in autoscaling to populate instanceGroupId.
	// +kubebuilder:validation:Optional
	InstanceGroupIDSelector *v1.Selector `json:"instanceGroupIdSelector,omitempty" tf:"-"`
