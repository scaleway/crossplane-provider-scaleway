...
type TemplateInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/cluster/file/v1alpha1.Filesystem
	// +listType=set
	...
	FilesystemIdsRefs []v1.Reference `json:"filesystemIdsRefs,omitempty" tf:"-"`

	// Selector for a list of Filesystem in file to populate filesystemIds.
	// +kubebuilder:validation:Optional
	FilesystemIdsSelector *v1.Selector `json:"filesystemIdsSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/cluster/instance/v1alpha1.PlacementGroup
	...
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/cluster/instance/v1alpha1.SecurityGroup
	...
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/cluster/iam/v1alpha1.SSHKey
	...
	// +kubebuilder:validation:Optional
	WindowsRdpSSHKeyIDRef *v1.Reference `json:"windowsRdpSshKeyIdRef,omitempty" tf:"-"`

	// Selector for a SSHKey in iam to populate windowsRdpSshKeyId.
	// +kubebuilder:validation:Optional
	WindowsRdpSSHKeyIDSelector *v1.Selector `json:"windowsRdpSshKeyIdSelector,omitempty" tf:"-"`
