...
type CustomerGatewayInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/scaleway/crossplane-provider-scaleway/apis/cluster/instance/v1alpha1.IP
	...
	IPv4PublicRef *v1.Reference `json:"ipv4PublicRef,omitempty" tf:"-"`

	// Selector for a IP in instance to populate ipv4Public.
	// +kubebuilder:validation:Optional
	IPv4PublicSelector *v1.Selector `json:"ipv4PublicSelector,omitempty" tf:"-"`
