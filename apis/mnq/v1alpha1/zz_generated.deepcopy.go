...
func (in *CredentialInitParameters) DeepCopyInto(out *CredentialInitParameters) {
	*out = *in
	...
	if in.NatsCredentials != nil {
		...
		*out = make([]NatsCredentialsInitParameters, len(*in))
		copy(*out, *in)
	}
	if in.Region != nil {
	...
	if in.SqsSnsCredentials != nil {
		...
		*out = make([]SqsSnsCredentialsInitParameters, len(*in))
		for i := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MNQNamespaceInitParameters) DeepCopyInto(out *MNQNamespaceInitParameters) {
	*out = *in
	if in.Name != nil {
		in, out := &in.Name, &out.Name
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MNQNamespaceInitParameters.
func (in *MNQNamespaceInitParameters) DeepCopy() *MNQNamespaceInitParameters {
	if in == nil {
		return nil
	}
	out := new(MNQNamespaceInitParameters)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SqsSnsCredentialsInitParameters) DeepCopyInto(out *SqsSnsCredentialsInitParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SqsSnsCredentialsInitParameters.
func (in *SqsSnsCredentialsInitParameters) DeepCopy() *SqsSnsCredentialsInitParameters {
	if in == nil {
		return nil
	}
	out := new(SqsSnsCredentialsInitParameters)
	in.DeepCopyInto(out)
	return out
}
